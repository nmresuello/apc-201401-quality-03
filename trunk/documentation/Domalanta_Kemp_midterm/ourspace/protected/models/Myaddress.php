...
class Myaddress extends CActiveRecord
{
	const a = "Domalanta";
		...
		public function kemp(){
		return array(self::a => "Domalanta", self::b=>"Domala");
		}
	/**
	...
	public function rules()
	{
		...
		return array(
			array('firstname, middlename, lastname, gender, created_at, home_address, landline, cellphone', 'required'),
