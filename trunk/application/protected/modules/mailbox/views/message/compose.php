	...
	<div class="form message-create">	
		...
		<div class="mailbox-input-row">
			...
			<div style="margin-left:80px">
				<?php echo $form->textField($conv,'to',array('style'=>'width:100%;color:#000000!important','id'=>'message-to','class'=>'mailbox-input', 'edit'=>$this->module->editToField? '1' : null)); ?>
		...
		<?php echo $form->textArea($msg,'text',array('cols'=>100,'rows'=>10, 'class'=>'mailbox-message-input','style'=>'width:100%;','placeholder'=>'Enter message here...')); ?>
