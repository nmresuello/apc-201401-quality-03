...
class TransactionController extends Controller
{
	 public function actionEmployees()
        {
        $giatUnit = (!empty($_POST['payroll_id'])) ? $_POST['payroll_id']: '0';

                $data=Transaction::model()->findAll('payroll_id=:payroll_id',
                                array(':payroll_id'=>$giatUnit));


                $data=CHtml::listData($data,'id','Names');
